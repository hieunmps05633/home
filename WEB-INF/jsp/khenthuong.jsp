                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Khen thưởng & Kỷ luật nhân viên : <div class="tennv">${student.fullname}</div>
                            </div>
                            <!-- /.panel-heading -->
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" >
                                 ...
                                 ${message}
                 <form:form action="khenthuong.htm" modelAttribute="student" enctype="multipart/form-data">
                                   ...
                                   <label>Họ và tên</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:input path="birthday" cssClass="form-control" type="hidden" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="img" type="file" >  <input type="hidden" name="txtimg" value="${student.photo}"/>
                                            <img src="img/${student.photo}" width="150px" height="150px">
                                        </div>

                                        <div class="form-group text-center" >
                                      
                                            <button name="btnCapNhat" class="btn btn-default"><img src="img/tru.png" width="20" height="20"> Kỷ Luật</button>
                                             <button name="btnKhen" class="btn btn-default"><img src="img/cong.png" width="20" height="20"> Khen Thưởng</button>
                                            <a href="ktkl.htm"> <button class="btn btn-default"> <a href="ktkl.htm"> Quay lại</a></button>
