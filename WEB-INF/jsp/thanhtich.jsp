                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" >
                                    ...
                                    <form:form action="thanhtich.htm" modelAttribute="student" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <button name="btnKhen" class="btn btn-default"><a><img src="img/cong.png" width="20" height="20">Khen Thưởng</a></button></hr>
                                            <button name="btnCapNhat" class="btn btn-default"><a><img src="img/tru.png" width="20" height="20">Kỷ Luật</a></button>
