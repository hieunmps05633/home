                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Danh sách phòng ban | <a href="khenthuongkyluat.htm">Thống kê điểm thưởng</a>
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover">
                                    ${message}
                                    <form:form action="khenthuongkyluat.htm" modelAttribute="khenthuong">
                                        ...
                                        <label>Thưởng</label>
                                            <form:input path="idstudent" cssClass="form-control" value="${student.id}"/>  
                                        </div>
                                    ...
                                    <c:forEach var="m" items="${khenthuongs}">
                                        <tr>
                                            <td>${m.id}</td>
                                            <td>${m.ngaydanhgia}</td>
                                            <td>${m.mark}</td>
