                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Đánh giá nhân viên <a link href="khenthuong.htm"><button class="btn btn-default">Thêm nhân viên</button></a>
                            </div>
                            <!-- /.panel-heading -->
                                    ...
                                    <c:forEach var="m" items="${students}">
                                        <tr>
                                           ...
                                           <td><c:if test="${m.gender =='true'}">Nam</c:if>
                                            <c:if test="${m.gender =='false'}">Nữ</c:if></td>
                                           
                                            <td>${m.mark}</td>
                                            <td>${m.major.name}</td>
                                            <td><c:if test="${m.mark >='10.0'}"><img src="img/king.png" width="30" height="30">    Xuất sắc</c:if>
                                               <c:if test="${m.mark =='9.0'}"><img src="img/gioi.png" width="30" height="30">   Giỏi</c:if>
                                                <c:if test="${m.mark =='8.0'}"><img src="img/gioi.png" width="30" height="30">   Giỏi</c:if>
                                                 <c:if test="${m.mark =='7.5'}"><img src="img/geat.png" width="30" height="30">   Khá</c:if>
                                                  <c:if test="${m.mark =='7.0'}"><img src="img/geat.png" width="30" height="30">   Khá</c:if>
                                                   <c:if test="${m.mark =='6.5'}"><img src="img/geat.png" width="30" height="30">   Khá</c:if>
                                                   <c:if test="${m.mark =='6.0'}"><img src="img/trungbinh.png" width="30" height="30">   Trung bình</c:if>
                                                   <c:if test="${m.mark =='5.5'}"><img src="img/trungbinh.png" width="30" height="30">   Trung bình</c:if>
                                                   <c:if test="${m.mark =='5.0'}"><img src="img/trungbinh.png" width="30" height="30">   Trung bình</c:if>
                                                   <c:if test="${m.mark =='4.5'}"><img src="img/lost.png" width="30" height="30">   Yếu</c:if>
                                                   <c:if test="${m.mark =='4.0'}"><img src="img/lost.png" width="30" height="30">   Yếu</c:if>
                                                   <c:if test="${m.mark =='3.5'}"><img src="img/lost.png" width="30" height="30">   Yếu</c:if>
                                                   <c:if test="${m.mark <='3.5'}"><img src="img/lost1.png" width="30" height="30">   Kém</c:if></td>
                                            <td><a href="thanhtich/${m.id}.htm">Chọn</a></td>
                                              <td ><a href="thanhtich/form2/${m.id}.htm">Gửi</a></td>
                                        </tr>
                                    </c:forEach>
