...
<span>Chưa có tài khoản nhấn <a href="user/register.htm">Tạo tài khoản</a></span>
			  ...
			  ${message}
                                  ...
                                  <div class="mailne1">
                                  Gửi mật khẩu cho <div class="mailne"> ${user.id}</div>
	<form action="mailer/send.htm" 	method="post">
		<p><input name="from" value="H.Company" type="hidden"></p>
		<p><input name="to"  value="${user.email}" type="hidden"></p>
		<p><input name="subject" value="Password of H.Company" type="hidden"></p>
                <p><input name="body"  value="Your Password is : ${user.password}" rows="3" cols="30" type="hidden"></textarea></p>
		<button class="btn btn-default">Gửi ngay</button>
	</form>
