                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Bổ sung thông tin cho nhân viên <div class="bosung">${user.id}</div>
                            </div>
                            <!-- /.panel-heading -->
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" >
                                 ...
                                 ${message} <button class="btn btn-default"><a href="user/index.htm">Quay lại</a></button>
                 <form:form action="bosung.htm" modelAttribute="student" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:input path="mark" cssClass="form-control" value="1.0" type="hidden" />  ${mark1}  
                                        </div>
